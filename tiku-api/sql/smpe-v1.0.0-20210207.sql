...
CREATE TABLE `sys_student`  (
  ...
  `idCard` bigint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '身份证号',
  `id` bigint(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '学号',
  `school` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '学校',
  `college` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '学院',
  `major` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '专业',
  `enrollment year` bigint(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '如学年度',
  `operation` bit(1) NOT NULL DEFAULT b'0' COMMENT '状态：1修改、0删除',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_id`(`id`) USING BTREE COMMENT '普通索引——id查询学号',
  INDEX `idx_name`(`name`) USING BTREE COMMENT '普通索引——name查询姓名',
  INDEX `idx_idCard`(`idCard`) USING BTREE COMMENT '普通索引——idCard查询身份证',
  INDEX `idx_college`(`college`) USING BTREE COMMENT '普通索引——college查询学院',
  INDEX `idx_major`(`major`) USING BTREE COMMENT '普通索引——major查询专业',
  INDEX `idx_enrollment year`(`enrollment year`) USING BTREE COMMENT '普通索引——enrollment year查询如学年度'
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生管理' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_student
-- ----------------------------
INSERT INTO `sys_student` VALUES ( , , , '河南师范大学', '软件学院', 'Java', '2019', b'0');
INSERT INTO `sys_student` VALUES ( , , , '河南师范大学', '软件学院', 'Java', '2019', b'0');
INSERT INTO `sys_student` VALUES ( , , , '河南师范大学', '软件学院', 'Java', '2019', b'0');
INSERT INTO `sys_student` VALUES ( , , , '河南师范大学', '软件学院', 'Java', '2019', b'0');
INSERT INTO `sys_student` VALUES ( , , , '河南师范大学', '软件学院', 'Java', '2019', b'0');
INSERT INTO `sys_student` VALUES ( , , , '河南师范大学', '软件学院', 'Java', '2019', b'0');
INSERT INTO `sys_student` VALUES ( , , , '河南师范大学', '软件学院', 'Web', '2019', b'0');
INSERT INTO `sys_student` VALUES ( , , , '河南师范大学', '软件学院', 'Web', '2019', b'0');
